...
const
    ...
    {jTormCssMethod} = require('@jtorm/css-method'),
    ...
    {jTormJsMethod} = require('@jtorm/js-method'),
...
// Plugins
const
    {jTormCssPlugin} = require('@jtorm/css-plugin'),
    {jTormJsPlugin} = require('@jtorm/js-plugin'),
